...
import com.example.demo.utility.UserRowMapper;
...
public class UserDAO {
	...
	public List<User> getAllUsers() {
		...
		return jdbcTemplate.query(SELECT_ALL_USERS_QUERY, new UserRowMapper());
	}
	
	
// CREATED SEPERATELY IN UTILITY PACKAGE AS AN USITLIT CLASS TO PROVIDE SCOPE OUTSIDE THIS CLASS ALSO AND CAN BE USED ANYWHERE
